...
int wait_E=60; // How long to wait at the ends
int PixelCount=10; //Set this to the AMOUNT of Led's/Pixels you have or want to use on your strip And It can be used to tell where to Stop then return the eye at in the strip
